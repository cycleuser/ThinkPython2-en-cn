...
It is common to give boolean functions names that sound like yes/no questions; is\_divisible returns either True or False to indicate whether x is divisible by y.  
Here is an example:
